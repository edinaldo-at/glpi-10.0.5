   ...
   // - prevent any global variables definition from current function logic.
    ...
    $constants = [
      // Constants related to system paths
        'GLPI_CONFIG_DIR'      => '/tmp/glpi/config', // Path for configuration files (db, security key, ...)
        'GLPI_VAR_DIR'         => '/var/lib/glpi',  // Path for all files
        'GLPI_MARKETPLACE_DIR' => GLPI_ROOT . '/marketplace', // Path for marketplace plugins
        'GLPI_DOC_DIR'         => '/var/lib/glpi', // Path for documents storage
        'GLPI_CACHE_DIR'       => '/var/lib/glpi/_cache', // Path for cache
        'GLPI_CRON_DIR'        => '/var/lib/glpi/_cron', // Path for cron storage
        'GLPI_DUMP_DIR'        => '/var/lib/glpi/_dumps', // Path for backup dump
        'GLPI_GRAPH_DIR'       => '/var/lib/glpi/_graphs', // Path for graph storage
        'GLPI_LOCAL_I18N_DIR'  => '/var/lib/glpi/_locales', // Path for local i18n files
        'GLPI_LOCK_DIR'        => '/var/lib/glpi/_lock', // Path for lock files storage (used by cron)
        'GLPI_LOG_DIR'         => '/var/log/glpi/_log', // Path for log storage
        'GLPI_PICTURE_DIR'     => '/var/lib/glpi/_pictures', // Path for picture storage
        'GLPI_PLUGIN_DOC_DIR'  => '/var/lib/glpi/_plugins', // Path for plugins documents storage
        'GLPI_RSS_DIR'         => '/var/lib/glpi/_rss', // Path for rss storage
        'GLPI_SESSION_DIR'     => '/var/lib/glpi/_sessions', // Path for sessions storage
        'GLPI_TMP_DIR'         => '/var/lib/glpi/_tmp', // Path for temp storage
        'GLPI_UPLOAD_DIR'      => '/var/lib/glpi/_uploads', // Path for upload storage
        "GLPI_INVENTORY_DIR"   => '/var/lib/glpi/_inventories', //Path for inventories
